	...
	<footer class="footer">
		<article class="inner-footer">
			<section class="footer-items">
				<h1>GrievanceDesk</h1>
				<p>
					Solution to all probelms at a single platform is provided by GrievanceDesk | One Platform solution. This service comes under the Education Department, Govt. of Andhra Pradesh.
				</p>
			</section>
			<section class="footer-items">
				<h2>Quick Links</h2>
			...
			<section class="footer-items">
				...
				<ul>
					...
					<li><i class="fa fa-envelope" aria-hidden="true"></i>GrievanceDesk@gmail.com</li>
				</ul>
		...
		<article class="footer-bottom">
			<a href="#">Privacy Policy</a> | Copyright &copy; GrievanceDesk | One Platform Solution. All Rights Reserved.
		</article>
	</footer>
</body>
</html>